...
int main() { 
  ...
  //Variables to contain the first total albums sold on the west and east coasts 
  long total1 = 0;

  //Variables to contain the second total albums sold on the west and east coasts 
  long total2 = 0;

  //Variables to contain the third total albums sold on the west and east coasts 
  long total3 = 0;
  ...
  //Variable used to contain inital values to later be added 
  long myNum = 0;
  ...
  cout << ((double)total1 / (total1 + total2 + total3)) * 100;

  //Set width to the constant of 25
  cout.width(width); 
  //Output the percent of album sold by album 2
  cout << ((double)total2 / (total1 + total2 + total3)) * 100;

  //Set width to the constant of 25
  cout.width(width); 
  //Output the percent of album sold by album 3
  cout << ((double)total1 / (total1 + total2 + total3)) * 100 << endl;
  ...
  cout << (((double)total1 * cost1) / ((total1 * cost1) + (total2 * cost2) + (total3 * cost3))) * 100;

  //Set width to the constant of 25
  cout.width(width); 
  //Output total profit precent of album 2
  cout << (((double)total2 * cost2) / ((total1 * cost1) + (total2 * cost2) + (total3 * cost3))) * 100;
  //Set width to the constant of 25
  cout.width(width); 
  //Output total profit precent of album 3
  cout << (((double)total3 * cost3) / ((total1 * cost1) + (total2 * cost2) + (total3 * cost3))) * 100;

...
//This function solves the first question and outputs it into the console 
int firstProblem() { 
...
//This function solves the second question and outputs it into the console
int secondProblem() { 
...
//This function solves the thrid question and outputs it into the console
int thirdProblem () { 
...
//This function solves the fourth question and outputs it into the console 
int fourthProblem() { 
  ...
  cout << "Fourth problem: Calculate & display the total number of whole hours and whole minutes that a total time of 20100 seconds contain.\n"; 
  cout << "\n"; 
  ...
  cout << "Minutes = " << ((totalSeconds / 60) / 60) % 60 << "\n";  
  cout << "\n\n";
...
int main() { 
  ...
  //Call first problem function
  firstProblem();
  //Call second problem function
  secondProblem();
  //Call third problem function
  thirdProblem(); 
  //Call fourth problem function 
  fourthProblem();

	...
	*/
	...
	public static void main(String[] args) {
		...
		if (test0 == true) {
			...
			try {
				completed = testChecker("main0", "test2", main0(2, 5), new ArrayList<>(Arrays.asList(2, 5)), 2) && completed;
			} catch (Exception exception) {
		...
		//scoring
		System.out.println("\n***YOUR SCORE ON THIS ASSIGNMENT: ( " + score + " ) out of 6 total***\n");

		//submission
		String command = "tar -cvf Homework1.tar Homework1.java";
		try {
		...
		System.out.println("Use the submit server link on the syllabus to upload your Homework1.tar file for grading.");

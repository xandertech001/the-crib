...
public class Homework3{
	...
	Please turn on all the test case flags before submission to the submitserver.
	...
	*/
	public static boolean test7 = false;
	...
	*/
	public static boolean test8 = false;
	...
	*/
	public static boolean test9 = false;
	...
	public static void main(String[] args) {
		...
		//submission
		String command = "tar -cvf Homework3.tar Homework3.java";
		try {
			Process process = Runtime.getRuntime().exec(command);
		} catch (Exception excep) {
			excep.printStackTrace();
			System.out.println("ERROR creating tarfile -- make sure you have tar utility installed");
		}

		System.out.println("Use the submit server link on the syllabus to upload your Homework3.tar file for grading.");
	}
